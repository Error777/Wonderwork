...
/obj/item/device/camera/orange //chinsky: Summer Springfield
	name = "orange camera"
	icon = 'icons/obj/custom_items.dmi'
...
/obj/item/device/camera/oldcamera //magmaram: Maria Crash
	name = "Old Camera"
	icon = 'icons/obj/custom_items.dmi'
...
/obj/item/clothing/head/welding/flame //madmalicemccrea: Alice McCrea
