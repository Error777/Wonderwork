...
/client/proc/cmd_admin_create_centcom_report()
	...
	var/customname = sanitize(input(usr, "Pick a title for the report.", "Title") as text|null, repl_chars = list("�"="�","�"="____255_"))
	if(!input)
		return
	if(!customname)
...
/client/proc/admin_call_shuttle()
	...
	captain_announce("������ ������������� �����. �� �������� �� ������� ����� [round(emergency_shuttle.timeleft()/60)] �����.")
