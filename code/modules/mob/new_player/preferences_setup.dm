				...
				if(MINER)
					...
					switch(backbag)
						...
						if(4)
							clothes_s.Blend(new /icon('icons/mob/back.dmi', "satchel"), ICON_OVERLAY)
				if(LAWYER)
					clothes_s = new /icon('icons/mob/uniform.dmi', "lawyer_s")
					clothes_s.Blend(new /icon('icons/mob/feet.dmi', "brown"), ICON_UNDERLAY)
...
/*datum/preferences
	...
	proc/update_preview_icon(just_wipe)		//seriously. This is horrendous.
		...
		var/icon/preview_icon = new /icon('icons/mob/human.dmi', "body_[g]_s")
