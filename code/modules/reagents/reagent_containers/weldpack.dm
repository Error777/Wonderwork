...
/obj/item/weapon/weldpack/proc/explode(var/mob/user)
	if(istype(user))
...
/obj/item/weapon/weldpack/water
	name = "Water kit"
	desc = "A portable water carrier."
	icon_state = "waterpack"

/obj/item/weapon/weldpack/water/New()
	var/datum/reagents/R = new/datum/reagents(max_fuel)
	reagents = R
	R.my_atom = src
	R.add_reagent("water", max_fuel)

/obj/item/weapon/weldpack/cleaner
	name = "Cleaner kit"
	desc = "When shit hits the fan..."
	icon_state = "cleanerpack"

/obj/item/weapon/weldpack/cleaner/New()
	var/datum/reagents/R = new/datum/reagents(max_fuel)
	reagents = R
	R.my_atom = src
	R.add_reagent("cleaner", max_fuel)