...
var/global/list/datum/stack_recipe/metal_recipes = list ( \
	...
	new/datum/stack_recipe("terminal frame", /obj/structure/computer2frame, 5, time = 25, one_per_turf = 1, on_floor = 1), \
	new/datum/stack_recipe("metacomputer frame", /obj/structure/computer3frame, 5, time = 25, one_per_turf = 1, on_floor = 1), \
	...
	new/datum/stack_recipe_list("airlock assemblies", list( \
		...
		new/datum/stack_recipe("hydroponics airlock assembly", /obj/structure/door_assembly/door_assembly_hyd, 4, time = 50, one_per_turf = 1, on_floor = 1), \
		new/datum/stack_recipe("black airlock assembly", /obj/structure/door_assembly/door_assembly_coma, 4, time = 50, one_per_turf = 1, on_floor = 1), \
		new/datum/stack_recipe("blue airlock assembly", /obj/structure/door_assembly/door_assembly_blue, 4, time = 50, one_per_turf = 1, on_floor = 1), \
	...
	new/datum/stack_recipe("dart", /obj/item/darts), \
...
var/global/list/datum/stack_recipe/plasteel_recipes = list ( \
	...
	new/datum/stack_recipe("RUST fuel assembly port frame", /obj/item/weapon/rust/fuel_assembly_port_frame, 12, time = 50, one_per_turf = 1), \
	new/datum/stack_recipe("RUST fuel compressor frame", /obj/item/weapon/rust/fuel_compressor_frame, 12, time = 50, one_per_turf = 1), \
	)
...
var/global/list/datum/stack_recipe/wood_recipes = list ( \
	...
	new/datum/stack_recipe("wooden bed", /obj/structure/stool/bed/wood, 3, time = 10, one_per_turf = 1, on_floor = 1), \
	new/datum/stack_recipe("wooden barricade", /obj/structure/barricade/wooden, 5, time = 50, one_per_turf = 1, on_floor = 1), \
	new/datum/stack_recipe("wooden door", /obj/structure/mineral_door/wood, 10, time = 20, one_per_turf = 1, on_floor = 1), \
	new/datum/stack_recipe("coffin", /obj/structure/closet/coffin, 5, time = 15, one_per_turf = 1, on_floor = 1), \
	new/datum/stack_recipe("dart board", /obj/structure/darts, 7, time = 20, one_per_turf = 1, on_floor = 1), \
