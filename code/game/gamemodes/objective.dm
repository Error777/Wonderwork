...
datum/objective/steal
	...
	var/global/possible_items[] = list(
		...
		"the \"Top Secret\" Nanotrasen secret documents" = /obj/item/weapon/documents/nanotrasen,
		"the bartender license" = /obj/item/weapon/documents/barlicense,
		"a teleportation gun" = /obj/item/weapon/gun/energy/teleport_gun,
		"a material synthesizer" = /obj/item/device/material_synth,
