...
/obj/machinery/door/airlock/glass_special
	name = "Maintenance Hatch"
...
/obj/machinery/door/airlock/blue
	name = "Airlock"
	icon = 'icons/obj/doors/Doorblue.dmi'
	assembly_type = /obj/structure/door_assembly/door_assembly_blue

/obj/machinery/door/airlock/glass_blue
	name = "Maintenance Hatch"
	icon = 'icons/obj/doors/Doorblueglass.dmi'
	opacity = 0
	assembly_type = /obj/structure/door_assembly/door_assembly_blue
	glass = 1
...
/obj/machinery/door/airlock/proc/synhack(mob/user as mob, obj/item/device/hacktool/I)
	if (src.synHacking==0)
		...
		spawn(20 * tick_multiplier)
			...
			// Alerting the AIs. Don't del this -- smet19
