...
/obj/structure/plasticflaps/mining/Del() //lazy hack to set the turf to allow air to pass if it's a simulated floor
	var/turf/T = get_turf(loc)
	if(T)
...
/obj/machinery/computer/ordercomp/Topic(href, href_list)
	...
	if(href_list["order"])
		...
		reqform.info += "ACCESS RESTRICTION: [replacetext_old(get_access_desc(P.access))]<br>"
