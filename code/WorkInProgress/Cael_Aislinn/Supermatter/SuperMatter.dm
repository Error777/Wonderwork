...
/obj/machinery/engine/supermatter/shard //Small subtype, less efficient and more sensitive, but less boom.
	...
	icon = 'code/WorkInProgress/Cael_AisLinn/Supermatter/Shard.dmi'
	gasefficency = 0.125
