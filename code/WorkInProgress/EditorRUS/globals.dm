...
// Change if needed
#define MUSICAL_GET_INSTRUMENT(instrument_name, sub_folder, sample_name) file("code/WorkInProgress/EditorRUS/samples/[#instrument_name]/[#sub_folder]/[#sample_name]")
