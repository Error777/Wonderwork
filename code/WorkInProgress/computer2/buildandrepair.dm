...
/obj/structure/computer2frame
	...
	var/created_icon_state = "terminal"
	...
	switch(state)
		...
		if(4)
			...
			if(istype(P, /obj/item/weapon/screwdriver))
				...
				var/obj/machinery/terminal/C= new /obj/machinery/terminal( src.loc )
