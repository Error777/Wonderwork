...
/obj/machinery/terminal/medical
	name = "medical terminal"
	icon_state = "medterminal"
	setup_has_radio = 1
...
/obj/machinery/terminal/arcade
	name = "arcade terminal"
	icon_state = "arcadeterminal"
...
/obj/machinery/terminal/power_change()
	if(stat & BROKEN)
...
/obj/machinery/terminal/attackby(obj/item/W as obj, mob/user as mob)
...
/obj/machinery/terminal/proc/send_command(command, datum/signal/signal)
...
/obj/machinery/terminal/proc/run_program(datum/computer/file/computer_program/program,datum/computer/file/computer_program/host)
	if(!program)
		return 0
...
/obj/machinery/terminal/proc/load_program(datum/computer/file/computer_program/program)
...
/obj/machinery/terminal/proc/unload_program(datum/computer/file/computer_program/program)
	if((!program) || (!src.hd))
		return 0
...
/obj/machinery/terminal/proc/delete_file(datum/computer/file/file)
	//world << "Deleting [file]..."
