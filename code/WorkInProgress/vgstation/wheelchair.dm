/obj/structure/stool/bed/chair/wheelchair2
	name = "wheelchair"
...
/obj/structure/stool/bed/chair/wheelchair2/update_icon()
	return

/obj/structure/stool/bed/chair/wheelchair2/set_dir()
	..()
	overlays = null
...
/obj/structure/stool/bed/chair/wheelchair2/attackby(obj/item/weapon/W as obj, mob/user as mob)
	if(istype(W, /obj/item/weapon/wrench) || istype(W,/obj/item/stack) || istype(W, /obj/item/weapon/wirecutters))
		return
	..()

/obj/structure/stool/bed/chair/wheelchair2/relaymove(mob/user, direction)
	// Redundant check?
...
/obj/structure/stool/bed/chair/wheelchair2/Move()
	..()
	if(buckled_mob)
...
/obj/structure/stool/bed/chair/wheelchair2/attack_hand(mob/living/user as mob)
	if (pulling)
		MouseDrop(usr)
	else
...
/obj/structure/stool/bed/chair/wheelchair2/MouseDrop(over_object, src_location, over_location)
	..()
...
/obj/structure/stool/bed/chair/wheelchair2/Bump(atom/A)
	..()
...
/obj/structure/stool/bed/chair/wheelchair2/proc/create_track()
