...
/obj/machinery/media/jukebox/
	...
	var/list/datum/track/tracks = list(
		new/datum/track("Jawa Bar", 'sound/turntable/Cantina_Band_Jawa_Bar_Tatooine_Mos_Eisly.ogg'),
		new/datum/track("Wade In The Water", 'sound/turntable/WadeInTheWater.ogg'),
		new/datum/track("Theme arranged for Piano Solo", 'sound/turntable/Max_Payne_Theme_arranged_for_Piano_Solo.ogg'),
		new/datum/track("Magic Fly", 'sound/turntable/Fly_me_to_the_moon.ogg'),
		new/datum/track("Onizukas Blues", 'sound/turntable/Onizukas_Blues.ogg'),
		new/datum/track("In The Mood", 'sound/turntable/GlennMiller-InTheMood.ogg'),
		new/datum/track("Wizard's Assistant", 'sound/turntable/Wizards_assistant.ogg'),
		new/datum/track("Cant Hardly Stand It", 'sound/turntable/CantHardlyStandIt.ogg')
	)
