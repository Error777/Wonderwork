/obj/machinery/stargate
	...
	anchored = 1
	dir = 2
	use_power = 1//So the sides dont use power
	unacidable = 1
...
*/
			if(6)//halloween
				for(var/obj/effect/landmark/miniworld/w6/faithless/L in world)
					new/mob/living/simple_animal/hostile/faithless(L.loc)
					del(L)
				for(var/obj/effect/landmark/miniworld/w6/crayon/L in world)
					new/obj/item/toy/crayon/rainbow(L.loc)
					new/obj/item/toy/crayon/rainbow(L.loc)
					new/obj/item/toy/crayon/rainbow(L.loc)
					new/obj/item/toy/crayon/rainbow(L.loc)
					new/obj/item/toy/crayon/rainbow(L.loc)
