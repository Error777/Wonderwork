...
/obj/machinery/vrpod/proc/go_in()
	...
	if(src.vrloc) //Make sure we found it~
		...
		return
	var/mob/living/carbon/human/VRbody = new /mob/living/carbon/human(src.vrloc)
	src.vrbody = VRbody
	...
	VRbody.dna.unique_enzymes = src.occupant.dna.unique_enzymes
	VRbody.dna.uni_identity = src.occupant.dna.uni_identity
	VRbody.dna.struc_enzymes = src.occupant.dna.struc_enzymes
