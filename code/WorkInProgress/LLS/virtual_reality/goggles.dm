...
/obj/item/clothing/glasses/virtual/perseus
	name = "perseus virtual reality goggles"
	glasses_type = 1

/obj/item/clothing/glasses/virtual/examine()
	..()
	// just some fluff
	usr << "\blue These glasses have an access level of [glasses_type + 1]."

/obj/item/clothing/glasses/virtual/New()
	..()
	spawn(0)
		if(vr_controller)
...
/obj/item/clothing/glasses/virtual/equipped(var/mob/living/L, var/slot)
	..()
	if(ishuman(L))
...
/obj/item/clothing/glasses/virtual/dropped(var/mob/living/carbon/human/H)
	..()
	LeaveVR()

/obj/item/clothing/glasses/virtual/Del()
	vr_controller.goggles -= src
	LeaveVR()
	..()

/obj/item/clothing/glasses/virtual/proc/EnterVR(var/mob/living/carbon/human/H)
	if(!H)
		return 0
...
/obj/item/clothing/glasses/virtual/proc/LeaveVR()
	if(!original_mob)
		return 0
