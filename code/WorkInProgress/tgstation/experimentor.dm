...
/obj/machinery/r_n_d/experimentor
	name = "Experimentor"
	icon = 'icons/obj/machines/network.dmi'
	icon_state = "generic0"
	density = 1
	anchored = 1
	use_power = 1
...
/obj/machinery/r_n_d/experimentor/proc/SetTypeReactions()
	...
	for(var/I in typesof(/obj/item))
		...
		if(ispath(I,/obj/item/weapon/rcd) || ispath(I,/obj/item/weapon/grenade) || ispath(I,/obj/item/device/aicard) || ispath(I,/obj/item/weapon/storage/backpack/holding) || ispath(I,/obj/item/metroid_core) || ispath(I,/obj/item/device/onetankbomb) || ispath(I,/obj/item/device/transfer_valve))
			var/obj/item/tempCheck = I
...
/obj/machinery/r_n_d/experimentor/proc/ejectItem(delete=0)
	if(loaded_item)
...
/obj/machinery/r_n_d/experimentor/proc/experiment(exp,obj/item/exp_on)
	...
	icon_state = "generic1"
	var/chosenchem
	var/criticalReaction = locate(exp_on) in critical_items ? TRUE : 0
	////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if(exp == SCANTYPE_HEAT)
		...
		if(prob(EFFECT_PROB_VERYLOW-badThingCoeff))
			...
			if(MT)
				...
				var/obj/item/projectile/energy/kinetic/FB = new /obj/item/projectile/energy/kinetic(start)
				FB.original = MT
				FB.current = start
				FB.yo = MT.y - start.y
				FB.xo = MT.x - start.x
	...
	if(exp == SCANTYPE_OBLITERATE)
		...
		//		linked_console.linked_lathe.materials.insert_amount( min((linked_console.linked_lathe.materials.max_material_storage - linked_console.linked_lathe.materials.TotalMaterials(), (exp_on.materials[material])), material)
		if(prob(EFFECT_PROB_VERYLOW-badThingCoeff))
...
/obj/item/weapon/relic/proc/petSpray(mob/user)
	...
	var/counter
	var/list/valid_animals = list(/mob/living/simple_animal/parrot,/mob/living/carbon/metroid,/mob/living/simple_animal/cat,/mob/living/simple_animal/corgi,/mob/living/simple_animal/crab,/mob/living/carbon/monkey,/mob/living/simple_animal/lizard,/mob/living/simple_animal/mouse,/mob/living/simple_animal/saturn,/mob/living/simple_animal/hostile/bear,/mob/living/simple_animal/bee,/mob/living/simple_animal/hostile/carp)
...
/obj/item/weapon/relic/proc/teleport(mob/user)
	...
	spawn(rand(10,30))
		...
		if(src.loc == user && userturf.z != 2) //Because Nuke Ops bringing this back on their shuttle, then looting the ERT area is 2fun4you!
